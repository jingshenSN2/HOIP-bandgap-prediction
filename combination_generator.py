    ...
    for ia in range(len(dfA)):
        ...
        for ib in range(len(dfB)):
            ...
            for ix in range(len(dfX)):
                ...
                Of = rb / rx
                newRow = pd.DataFrame(
                    [[la['A-site'], lb['B-site'], lx['X-site'], Tf, Of, la['r_A.eff'], la['P_A'], la['A_HOMO'],
                      lb['χ_B'], lb['r_B_s+p'], la['A_LUMO'], lb['r_B'], lb['IE_B'], lb['P_B'], lb['EA_B'],
                      lx['X_p-electron'], lb['IC_B'], lb['1st_IP_B'], lb['VE_B'], lb['B_d-electron'], lx['1st_IP_X'],
                      lx['χ_X'], lx['P_X'], lx['IC_X'], lx['r_X_s+p'], lx['r_X'], lx['X_s-electron'],
